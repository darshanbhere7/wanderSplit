...
class ExpenseService {
  ...
  // Delete an expense and update trip total
  Future<void> deleteExpense(String tripId, String expenseId) async {
    try {
      final tripRef = _firestore.collection('trips').doc(tripId);
      final expenseRef = tripRef.collection('expenses').doc(expenseId);
      ...
      // Delete the expense and update trip total in a transaction
