...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  Future<void> _addExpense() async {
    ...
    try {
      ...
      // Get the trip data to update total expenses and participants
      ...
      final participants = List<String>.from(tripData['participants'] ?? []);
      ...
      final expenseSplit = ExpenseSplit(
        ...
        paidBy: currentUser.uid,
        totalAmount: amount,
        splits: {}, // Will be calculated based on participants
      );

      // Calculate and save the splits
      final calculatedSplits = expenseSplit.calculateSplits(participants);
      final updatedSplit = ExpenseSplit(
        expenseId: expenseRef.id,
        tripId: widget.tripId,
        paidBy: currentUser.uid,
        totalAmount: amount,
      ...
      await _expenseSplitService.createExpenseSplit(updatedSplit);
